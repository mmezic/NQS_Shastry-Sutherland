import numpy as np
"""lattice"""
SITES    = 16             # 4, 8, 16, 20, 36, 64, 100 ... number of particles
...
INDICES = range(0,48)                   # A list of indices. Each index corresponds to one row in the non-simplyfied benchmarking table from the appendix B.
